...
docker run -P --name ttnd1 --hostname="$h1" -d nmongo --replSet ttnd --noprealloc --smallfiles
docker run -P --name ttnd2 --hostname="$h2" -d nmongo --replSet ttnd --noprealloc --smallfiles
docker run -P --name ttnd3 --hostname="$h3" -d nmongo --replSet ttnd --noprealloc --smallfiles
